...
const plugins = [
  ...
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-glimmer/,
    contextRegExp: /\/prettier/,
  }),
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-graphql/,
    contextRegExp: /\/prettier/,
  }),
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-markdown/,
    contextRegExp: /\/prettier/,
  }),
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-parse5/,
    contextRegExp: /\/prettier/,
  }),
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-postcss/,
    contextRegExp: /\/prettier/,
  }),
  new webpack.IgnorePlugin({
  ...
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-vue/,
    contextRegExp: /\/prettier/,
  }),
  new webpack.IgnorePlugin({
    resourceRegExp: /parser-yaml/,
    contextRegExp: /\/prettier/,
  }),
