...
const ID = 'amf-graphql-federation-parser'
...
export default {
    ...
    async parse({ parser, adapter }, code) {
        ...
        let client = parser.GraphQLFederationConfiguration.GraphQLFederation().withErrorHandlerProvider(provider).baseUnitClient()
