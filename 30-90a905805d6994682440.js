...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";function _interopRequireWildcard(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i]);return t["default"]=e,t}function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function isBlockScoped(e){return!!t.isVariableDeclaration(e)&&(!!e[t.BLOCK_SCOPED_SYMBOL]||("let"===e.kind||"const"===e.kind))}function convertBlockScopedToVar(e,i,r,n){var a=!(arguments.length<=4||void 0===arguments[4])&&arguments[4];if(i||(i=e.node),!t.isFor(r))for(var s=0;s<i.declarations.length;s++){var o=i.declarations[s];o.init=o.init||n.buildUndefinedNode()}if(i[t.BLOCK_SCOPED_SYMBOL]=!0,i.kind="var",a){var l=n.getFunctionParent(),c=e.getBindingIdentifiers();for(var p in c){var u=n.getOwnBinding(p);u&&(u.kind="var"),n.moveBindingTo(p,l)}}}function isVar(e){return t.isVariableDeclaration(e,{kind:"var"})&&!isBlockScoped(e)}function replace(e,t,i,r){var n=r[t.name];if(n){var a=i.getBindingIdentifier(t.name);a===n.binding?i.rename(t.name,n.uid):e&&e.skip()}}function traverseReplace(e,i,r,n){if(t.isIdentifier(e)&&replace(e,i,r,n),t.isAssignmentExpression(e)){var a=t.getBindingIdentifiers(e);for(var s in a)replace(a[s],i,r,n)}r.traverse(e,replaceVisitor,n)}function loopNodeTo(e){return t.isBreakStatement(e)?"break":t.isContinueStatement(e)?"continue":void 0}exports.__esModule=!0;var _symbol=__webpack_require__("./node_modules/babel-runtime/core-js/symbol.js"),_symbol2=_interopRequireDefault(_symbol),_create=__webpack_require__("./node_modules/babel-runtime/core-js/object/create.js"),_create2=_interopRequireDefault(_create),_classCallCheck2=__webpack_require__("./node_modules/babel-runtime/helpers/classCallCheck.js"),_classCallCheck3=_interopRequireDefault(_classCallCheck2);exports["default"]=function(){return{visitor:{VariableDeclaration:function(e,i){var r=e.node,n=e.parent,a=e.scope;if(isBlockScoped(r)&&(convertBlockScopedToVar(e,null,n,a,!0),r._tdzThis)){for(var s=[r],o=0;o<r.declarations.length;o++){var l=r.declarations[o];if(l.init){var c=t.assignmentExpression("=",l.id,l.init);c._ignoreBlockScopingTDZ=!0,s.push(t.expressionStatement(c))}l.init=i.addHelper("temporalUndefined")}r._blockHoist=2,e.isCompletionRecord()&&s.push(t.expressionStatement(a.buildUndefinedNode())),e.replaceWithMultiple(s)}},Loop:function(e,i){var r=e.node,n=e.parent,a=e.scope;t.ensureBlock(r);var s=new BlockScoping(e,e.get("body"),n,a,i),o=s.run();o&&e.replaceWith(o)},"BlockStatement|SwitchStatement|Program":function(e,i){if(!t.isLoop(e.parent)){var r=new BlockScoping(null,e,e.parent,e.scope,i);r.run()}}}}};var _babelTraverse=__webpack_require__("./node_modules/babel-traverse/lib/index.js"),_babelTraverse2=_interopRequireDefault(_babelTraverse),_tdz=__webpack_require__("./node_modules/babel-plugin-transform-es2015-block-scoping/lib/tdz.js"),_babelTypes=__webpack_require__("./node_modules/babel-types/lib/index.js"),t=_interopRequireWildcard(_babelTypes),_values=__webpack_require__("./node_modules/lodash/values.js"),_values2=_interopRequireDefault(_values),_extend=__webpack_require__("./node_modules/lodash/extend.js"),_extend2=_interopRequireDefault(_extend),_babelTemplate=__webpack_require__("./node_modules/babel-template/lib/index.js"),_babelTemplate2=_interopRequireDefault(_babelTemplate),buildRetCheck=(0,_babelTemplate2["default"])('\n  if (typeof RETURN === "object") return RETURN.v;\n'),replaceVisitor={ReferencedIdentifier:function(e,t){replace(e,e.node,e.scope,t)},AssignmentExpression:function(e,t){var i=e.getBindingIdentifiers();for(var r in i)replace(null,i[r],e.scope,t)}},letReferenceBlockVisitor=_babelTraverse2["default"].visitors.merge([{Function:function(e,t){return e.traverse(letReferenceFunctionVisitor,t),e.skip()}},_tdz.visitor]),letReferenceFunctionVisitor=_babelTraverse2["default"].visitors.merge([{ReferencedIdentifier:function(e,t){var i=t.letReferences[e.node.name];if(i){var r=e.scope.getBindingIdentifier(e.node.name);r&&r!==i||(t.closurify=!0)}}},_tdz.visitor]),hoistVarDeclarationsVisitor={enter:function(e,i){var r=e.node,n=e.parent;if(e.isForStatement()){if(isVar(r.init,r)){var a=i.pushDeclar(r.init);1===a.length?r.init=a[0]:r.init=t.sequenceExpression(a)}}else if(e.isFor())isVar(r.left,r)&&(i.pushDeclar(r.left),r.left=r.left.declarations[0].id);else if(isVar(r,n))e.replaceWithMultiple(i.pushDeclar(r).map(function(e){return t.expressionStatement(e)}));else if(e.isFunction())return e.skip()}},loopLabelVisitor={LabeledStatement:function(e,t){var i=e.node;t.innerLabels.push(i.label.name)}},continuationVisitor={enter:function(e,t){if(e.isAssignmentExpression()||e.isUpdateExpression()){var i=e.getBindingIdentifiers();for(var r in i)t.outsideReferences[r]===e.scope.getBindingIdentifier(r)&&(t.reassignments[r]=!0)}}},loopVisitor={Loop:function(e,t){var i=t.ignoreLabeless;t.ignoreLabeless=!0,e.traverse(loopVisitor,t),t.ignoreLabeless=i,e.skip()},Function:function(e){e.skip()},SwitchCase:function(e,t){var i=t.inSwitchCase;t.inSwitchCase=!0,e.traverse(loopVisitor,t),t.inSwitchCase=i,e.skip()},"BreakStatement|ContinueStatement|ReturnStatement":function(e,i){var r=e.node,n=e.parent,a=e.scope;if(!r[this.LOOP_IGNORE]){var s=void 0,o=loopNodeTo(r);if(o){if(r.label){if(i.innerLabels.indexOf(r.label.name)>=0)return;o=o+"|"+r.label.name}else{if(i.ignoreLabeless)return;if(i.inSwitchCase)return;if(t.isBreakStatement(r)&&t.isSwitchCase(n))return}i.hasBreakContinue=!0,i.map[o]=r,s=t.stringLiteral(o)}e.isReturnStatement()&&(i.hasReturn=!0,s=t.objectExpression([t.objectProperty(t.identifier("v"),r.argument||a.buildUndefinedNode())])),s&&(s=t.returnStatement(s),s[this.LOOP_IGNORE]=!0,e.skip(),e.replaceWith(t.inherits(s,r)))}}},BlockScoping=function(){function e(i,r,n,a,s){(0,_classCallCheck3["default"])(this,e),this.parent=n,this.scope=a,this.file=s,this.blockPath=r,this.block=r.node,this.outsideLetReferences=(0,_create2["default"])(null),this.hasLetReferences=!1,this.letReferences=(0,_create2["default"])(null),this.body=[],i&&(this.loopParent=i.parent,this.loopLabel=t.isLabeledStatement(this.loopParent)&&this.loopParent.label,this.loopPath=i,this.loop=i.node)}return e.prototype.run=function(){var e=this.block;if(!e._letDone){e._letDone=!0;var i=this.getLetReferences();if(t.isFunction(this.parent)||t.isProgram(this.block))return void this.updateScopeInfo();if(this.hasLetReferences)return i?this.wrapClosure():this.remap(),this.updateScopeInfo(),this.loopLabel&&!t.isLabeledStatement(this.loopParent)?t.labeledStatement(this.loopLabel,this.loop):void 0}},e.prototype.updateScopeInfo=function(){var e=this.scope,t=e.getFunctionParent(),i=this.letReferences;for(var r in i){var n=i[r],a=e.getBinding(n.name);a&&("let"!==a.kind&&"const"!==a.kind||(a.kind="var",e.moveBindingTo(n.name,t)))}},e.prototype.remap=function(){var e=!1,t=this.letReferences,i=this.scope,r=(0,_create2["default"])(null);for(var n in t){var a=t[n];if(i.parentHasBinding(n)||i.hasGlobal(n)){var s=i.generateUidIdentifier(a.name).name;a.name=s,e=!0,r[n]=r[s]={binding:a,uid:s}}}if(e){var o=this.loop;o&&(traverseReplace(o.right,o,i,r),traverseReplace(o.test,o,i,r),traverseReplace(o.update,o,i,r)),this.blockPath.traverse(replaceVisitor,r)}},e.prototype.wrapClosure=function(){var e=this.block,i=this.outsideLetReferences;if(this.loop)for(var r in i){var n=i[r];(this.scope.hasGlobal(n.name)||this.scope.parentHasBinding(n.name))&&(delete i[n.name],delete this.letReferences[n.name],this.scope.rename(n.name),this.letReferences[n.name]=n,i[n.name]=n)}this.has=this.checkLoop(),this.hoistVarDeclarations();var a=(0,_values2["default"])(i),s=(0,_values2["default"])(i),o=this.blockPath.isSwitchStatement(),l=t.functionExpression(null,a,t.blockStatement(o?[e]:e.body));l.shadow=!0,this.addContinuations(l);var c=l;this.loop&&(c=this.scope.generateUidIdentifier("loop"),this.loopPath.insertBefore(t.variableDeclaration("var",[t.variableDeclarator(c,l)])));var p=t.callExpression(c,s),u=this.scope.generateUidIdentifier("ret"),d=_babelTraverse2["default"].hasType(l.body,this.scope,"YieldExpression",t.FUNCTION_TYPES);d&&(l.generator=!0,p=t.yieldExpression(p,!0));var h=_babelTraverse2["default"].hasType(l.body,this.scope,"AwaitExpression",t.FUNCTION_TYPES);h&&(l.async=!0,p=t.awaitExpression(p)),this.buildClosure(u,p),o?this.blockPath.replaceWithMultiple(this.body):e.body=this.body},e.prototype.buildClosure=function(e,i){var r=this.has;r.hasReturn||r.hasBreakContinue?this.buildHas(e,i):this.body.push(t.expressionStatement(i))},e.prototype.addContinuations=function(e){var i={reassignments:{},outsideReferences:this.outsideLetReferences};this.scope.traverse(e,continuationVisitor,i);for(var r=0;r<e.params.length;r++){var n=e.params[r];if(i.reassignments[n.name]){var a=this.scope.generateUidIdentifier(n.name);e.params[r]=a,this.scope.rename(n.name,a.name,e),e.body.body.push(t.expressionStatement(t.assignmentExpression("=",n,a)))}}},e.prototype.getLetReferences=function(){var e=this.block,i=[];if(this.loop){var r=this.loop.left||this.loop.init;isBlockScoped(r)&&(i.push(r),(0,_extend2["default"])(this.outsideLetReferences,t.getBindingIdentifiers(r)))}if(e.body)for(var n=0;n<e.body.length;n++){var a=e.body[n];if(t.isClassDeclaration(a)||t.isFunctionDeclaration(a)||isBlockScoped(a)){var s=this.blockPath.get("body")[n];isBlockScoped(a)&&convertBlockScopedToVar(s,null,e,this.scope),i=i.concat(a.declarations||a)}}if(e.cases)for(var o=0;o<e.cases.length;o++)for(var l=e.cases[o].consequent,c=0;c<l.length;c++){var p=l[c];if(t.isClassDeclaration(p)||t.isFunctionDeclaration(p)||isBlockScoped(p)){var u=this.blockPath.get("cases")[o];isBlockScoped(p)&&convertBlockScopedToVar(u,p,e,this.scope),i=i.concat(p.declarations||p)}}for(var d=0;d<i.length;d++){var h=i[d],f=t.getBindingIdentifiers(h);(0,_extend2["default"])(this.letReferences,f),this.hasLetReferences=!0}if(this.hasLetReferences){var v={letReferences:this.letReferences,closurify:!1,file:this.file};return this.blockPath.traverse(letReferenceBlockVisitor,v),v.closurify}},e.prototype.checkLoop=function(){var e={hasBreakContinue:!1,ignoreLabeless:!1,inSwitchCase:!1,innerLabels:[],hasReturn:!1,isLoop:!!this.loop,map:{},LOOP_IGNORE:(0,_symbol2["default"])()};return this.blockPath.traverse(loopLabelVisitor,e),this.blockPath.traverse(loopVisitor,e),e},e.prototype.hoistVarDeclarations=function(){this.blockPath.traverse(hoistVarDeclarationsVisitor,this)},e.prototype.pushDeclar=function(e){var i=[],r=t.getBindingIdentifiers(e);for(var n in r)i.push(t.variableDeclarator(r[n]));this.body.push(t.variableDeclaration(e.kind,i));for(var a=[],s=0;s<e.declarations.length;s++){var o=e.declarations[s];if(o.init){var l=t.assignmentExpression("=",o.id,o.init);a.push(t.inherits(l,o))}}return a},e.prototype.buildHas=function(e,i){var r=this.body;r.push(t.variableDeclaration("var",[t.variableDeclarator(e,i)]));var n=void 0,a=this.has,s=[];if(a.hasReturn&&(n=buildRetCheck({RETURN:e})),a.hasBreakContinue){for(var o in a.map)s.push(t.switchCase(t.stringLiteral(o),[a.map[o]]));if(a.hasReturn&&s.push(t.switchCase(null,[n])),1===s.length){var l=s[0];r.push(t.ifStatement(t.binaryExpression("===",e,l.test),l.consequent[0]))}else{for(var c=0;c<s.length;c++){var p=s[c].consequent[0];t.isBreakStatement(p)&&!p.label&&(p.label=this.loopLabel=this.loopLabel||this.scope.generateUidIdentifier("loop"))}r.push(t.switchStatement(e,s))}}else a.hasReturn&&r.push(n)},e}();module.exports=exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignValue=__webpack_require__("./node_modules/lodash/_assignValue.js"),copyObject=__webpack_require__("./node_modules/lodash/_copyObject.js"),createAssigner=__webpack_require__("./node_modules/lodash/_createAssigner.js"),isArrayLike=__webpack_require__("./node_modules/lodash/isArrayLike.js"),isPrototype=__webpack_require__("./node_modules/lodash/_isPrototype.js"),keysIn=__webpack_require__("./node_modules/lodash/keysIn.js"),objectProto=Object.prototype,propertyIsEnumerable=objectProto.propertyIsEnumerable,nonEnumShadows=!propertyIsEnumerable.call({valueOf:1},"valueOf"),assignIn=createAssigner(function(e,r){if(nonEnumShadows||isPrototype(r)||isArrayLike(r))return void copyObject(r,keysIn(r),e);for(var s in r)assignValue(e,s,r[s])});module.exports=assignIn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}exports.__esModule=!0;var _getIterator2=__webpack_require__("./node_modules/babel-runtime/core-js/get-iterator.js"),_getIterator3=_interopRequireDefault(_getIterator2);exports["default"]=function(e){var r=e.types,t="@flow";return{inherits:__webpack_require__("./node_modules/babel-plugin-syntax-flow/lib/index.js"),visitor:{Program:function(e,r){for(var o=r.file.ast.comments,a=o,n=Array.isArray(a),i=0,a=n?a:(0,_getIterator3["default"])(a);;){var l;if(n){if(i>=a.length)break;l=a[i++]}else{if(i=a.next(),i.done)break;l=i.value}var u=l;u.value.indexOf(t)>=0&&(u.value=u.value.replace(t,""),u.value.replace(/\*/g,"").trim()||(u.ignore=!0))}},Flow:function(e){e.remove()},ClassProperty:function(e){e.node.typeAnnotation=null,e.node.value||e.remove()},Class:function(e){var r=e.node;r["implements"]=null},Function:function(e){for(var r=e.node,t=0;t<r.params.length;t++){var o=r.params[t];o.optional=!1}},TypeCastExpression:function(e){var t=e.node;do t=t.expression;while(r.isTypeCastExpression(t));e.replaceWith(t)}}}},module.exports=exports["default"];
